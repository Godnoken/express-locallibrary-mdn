    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            .exec(function(err, books) {
                ...
                res.render('bookinstance_form', { title: 'Update Book-instance', book_list: books, selected_book: bookinstance.book._id, bookinstance: bookinstance, errors: errors.array() });
            });
            return;
        }
        else {
